...
<header class="pt-32 pb-24 px-6 bg-white overflow-hidden relative">
    {{-- Ligne décorative d'arrière-plan --}}
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200vw] h-[1px] bg-gradient-to-r from-transparent via-red-100 to-transparent"></div>
    ...
    <div class="max-w-7xl mx-auto">
        <div class="bg-white rounded-[4rem] shadow-2xl overflow-hidden border border-gray-50">
            <div class="grid lg:grid-cols-5 gap-0">
                ...
                {{-- Colonne Infos (2/5) - Style "Sacristie" Sombre --}}
                ...
                <div class="lg:col-span-3 p-12 md:p-20 bg-white">
                    <form action="#" method="POST" class="space-y-12">
                        @csrf
                        {{-- ======== CHANGEMENT ICI : Séparation Nom et Prénom ======== --}}
                        <div class="grid md:grid-cols-2 gap-12">
                            <div class="relative group">
                                <label for="first_name" class="text-[9px] font-black text-black uppercase tracking-[0.3em] mb-4 block">Votre Prénom</label>
                                <input type="text" id="first_name" name="first_name" placeholder="Jean" 
                                    class="w-full pb-4 bg-transparent border-t-0 border-x-0 border-b border-gray-100 focus:border-red-900 focus:ring-0 outline-none transition-all placeholder:text-gray-300 font-light italic">
                            </div>
                            <div class="relative group">
                                <label for="last_name" class="text-[9px] font-black text-black uppercase tracking-[0.3em] mb-4 block">Votre Nom</label>
                        ...
                        <div class="relative group">
                            <label for="email" class="text-[9px] font-black text-black uppercase tracking-[0.3em] mb-4 block">Votre Email</label>
                            <input type="email" id="email" name="email" placeholder="adresse@email.com" 
                                class="w-full pb-4 bg-transparent border-t-0 border-x-0 border-b border-gray-100 focus:border-red-900 focus:ring-0 outline-none transition-all placeholder:text-gray-300 font-light italic">
                        </div>

                        <div class="relative">
                            <label for="subject" class="text-[9px] font-black text-black uppercase tracking-[0.3em] mb-4 block">Sujet de l'échange</label>
                            <select id="subject" name="subject" class="w-full pb-4 bg-transparent border-t-0 border-x-0 border-b border-gray-100 focus:border-red-900 focus:ring-0 outline-none transition-all appearance-none font-light italic text-gray-500">
                        ...
                        <div class="relative">
                            <label for="message" class="text-[9px] font-black text-black uppercase tracking-[0.3em] mb-4 block">Votre Message</label>
                            <textarea id="message" name="message" rows="4" placeholder="Écrivez ici..." 
                                class="w-full pb-4 bg-transparent border-t-0 border-x-0 border-b border-gray-100 focus:border-red-900 focus:ring-0 outline-none transition-all resize-none placeholder:text-gray-300 font-light italic"></textarea>
                        </div>
                        ...
                        <div class="pt-6">
                            <button type="submit" class="group flex items-center gap-8 text-[11px] font-black uppercase tracking-[0.4em] text-black">
                                ...
                                <span class="relative flex items-center">
                                    <span class="w-12 h-[1px] bg-black transition-all duration-500 group-hover:w-20"></span>
                                    <i class="fas fa-paper-plane text-[8px] ml-2 opacity-0 transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-1"></i>
                                </span>
                            </button>
                        </div>
                    </form>
...
<section class="pb-32 px-6">
    <div class="max-w-7xl mx-auto h-[500px] overflow-hidden rounded-[250px_250px_40px_40px] shadow-2xl border-4 border-white">
        <iframe
            ...
            class="w-full h-full border-0 grayscale hover:grayscale-0 transition-all duration-[3s]"
            allowfullscreen=""
            loading="lazy">
        </iframe>
    </div>
