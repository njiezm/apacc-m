...
<h4 class="font-bold text-white text-[30px] sm:text-[35px] md:text-[35px] mb-2 uppercase tracking-tighter text-center">{{ $action['title'] }}</h4>                    <h6 class="text-sm font-light italic text-white lowercase tracking-widest mb-4 mt-5">{{ $action['sub'] }}</h6>
